...
function OnFirstTalk(event, player, unit)
    ...
    if player:GetLevel() == 1 then
		...
		if not player:HasItem(800048, 1) and not player:HasItem(90000, 1) and not player:HasItem(65000, 1) then
