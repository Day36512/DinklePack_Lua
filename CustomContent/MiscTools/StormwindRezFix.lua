...
local function PlayerReleasesSpirit(event, player)
    ...
    if playerArea == Area1 or playerArea == Area2 or playerArea == Area3 or playerArea == Area4 or playerArea == Area5 or playerArea == Area6 or playerArea == Area7 or playerArea == Area8 or playerArea == Area9 or playerArea == Area10 then
