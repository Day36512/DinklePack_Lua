...
local function OnGossipSelect(event, player, item, sender, intid, code)
    ...
    elseif (sender == 200) then
		...
		player:GossipMenuAddItem(0, "11. Do I have to worry about my class getting nerfed or significantly altered?", 2, 211)
